...
- **E14-B + E12（site B 复工，done）**：b0repro dense 基线 4 seed 逐位复现 site A（差值全 0，PASS）；**top_k 单调性**——Δ(tk2)=+0.005012（3.70×地板）> Δ(tk1)=+0.004081（3.01×），4/4 正 → top_k=2 为最优协作度；**E12 专家利用率**——覆盖 5/5 但负载比 3.3–11 → 负载失衡（collapsed 分支）→ 下一步 E12b load-balance。见 [`site B 复工结论`](../docs/20260819-0745-siteB复工结论-b0repro-E14B-E12.md)。

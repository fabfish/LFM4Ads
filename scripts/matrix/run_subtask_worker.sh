...
#
# 用法:
#   bash scripts/matrix/run_subtask_worker.sh <device> <model> <seed> "rm:em:sm rm:em:sm ..."
# 例:
#   bash scripts/matrix/run_subtask_worker.sh cuda:0 partial-shared 42 "suppress:none:none suppress:none:encourage"
#
# 设计要点:

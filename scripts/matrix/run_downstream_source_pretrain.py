...
Usage:
  python scripts/matrix/run_downstream_source_pretrain.py --model dense --device cuda:1 --seed 42
  python scripts/matrix/run_downstream_source_pretrain.py --model moe   --device cuda:1 --seed 42
"""

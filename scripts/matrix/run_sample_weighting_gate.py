...
用法：
  python scripts/matrix/run_sample_weighting_gate.py run <run-code>
  python scripts/matrix/run_sample_weighting_gate.py run-all --stage gate
  python scripts/matrix/run_sample_weighting_gate.py run-all --stage moe

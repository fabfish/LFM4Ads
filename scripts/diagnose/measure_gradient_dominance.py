...
Usage:
    ...
    python scripts/diagnose/measure_gradient_dominance.py --device cuda:0 --arch v2 \
        --ckpt cache/checkpoints/dcnv2_moe_v2_k4.pt --top-k 2 --tag v2

    # MoE V1
    python scripts/diagnose/measure_gradient_dominance.py --device cuda:0 --arch v1 \
